...
/**
 * Esta clase es la aplicación principal de los premios de cine.
 */
public class PremiosCineApp {

	/**
	 * Método principal que inicia la aplicación de los premios de cine.
	 * 
	 * @param args Los argumentos de la línea de comandos (no utilizado en esta
	 *             aplicación).
	 */
	public static void main(String[] args) {
		...
		System.out
				.println("La película ganadora del Oscar a la Mejor Película es: " + ganadoraMejorPelicula.getTitulo());
	}
}
